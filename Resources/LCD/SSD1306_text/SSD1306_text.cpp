...
static uint8_t initTable[] PROGMEM = {		// Initialization command sequence
...
static uint8_t clearScreenTable[] PROGMEM = {	// Clear screen command sequence
  SSD1306_COLUMNADDR,
